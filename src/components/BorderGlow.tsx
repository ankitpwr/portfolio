...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  fillOpacity = 0.5,
  isDark = true, // Default to true so it doesn't break if prop is missing
}) => {
  ...
  return (
    <div
      ...
      // Updated static border for light mode
      className={`relative grid isolate border border-zinc-200 dark:border-white/15 transition-colors duration-300 ${className}`}
      style={{
        background: backgroundColor,
        borderRadius: `${borderRadius}px`,
        transform: "translate3d(0, 0, 0.01px)",
        // Softer, cleaner shadow for light mode, rich shadow for dark mode
        boxShadow: isDark
          ? "rgba(0,0,0,0.1) 0 4px 8px, rgba(0,0,0,0.1) 0 16px 32px"
        ...
        style={
          {
            ...
            opacity: glowOpacity,
            // Use 'normal' for light mode so color paints over the white background
